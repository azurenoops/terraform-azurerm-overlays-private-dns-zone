...
variable "custom_private_dns_zone_name" {
  description = "The name of the custom dns zone name to create. If not set, the name will be generated using the `org_name`, `workload_name`, `deploy_environment` and `environment` variables."
  type        = string
  default     = null
}
